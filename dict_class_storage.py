...
class Store_Item:
    ...
    def __repr__(self):
        return f"Main img url : {self.img}, Secondary Image Url : {self.secondary},Main Alt Text: {self.alt},Secondary Alt Text : {self.alt_secondary}, Item Name : {self.name}, Item Description : {self.desc}, Item Base Price : {self.price}, Remaining stock : {self.stock} "
